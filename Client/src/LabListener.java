...
public abstract class LabListener implements ActionListener {
    ...
    public static LabCollection makeCall(String command,Human object) {
        try {
            ...
            TreeSet<Human> receivedCollection1=LabCollection.deserializeTree(receivePacket.getData());
            clientSocket.close();
            LabCollection receivedCollection =new LabCollection();
            receivedCollection.addUselessData(receivedCollection1);
